...
const NAV=[
  ...
  {g:"Management",items:[{k:"staff",l:"Staff Center"},{k:"roles",l:"Roles & Permissions"},{k:"cashier",l:"Cashier Features"},{k:"customers",l:"Customer Features"},{k:"inventory",l:"Inventory"},{k:"barcode",l:"Barcode Scanner"},{k:"kotprinter",l:"Auto KOT Printer"},{k:"branches",l:"Multi Branch"},{k:"loyalty",l:"Loyalty Points"},{k:"settings",l:"Settings"}]},
];
const ROLE_NAV={
...
function appState(){
  return {restaurantName,logoImg,role,MENU,orders,salesLog,seq,selNo,tables,bookings,serviceReqs,staff,inventory,promos,customers,branches,rolePerms,barcodeText};
}
...
let cashierShift={opening:500,cash:1280,card:740,qr:360,expense:120,closed:false};
...
function closingAutoData(){
  ...
  const expected=cashierShift.opening+cash-cashierShift.expense;
  const actual=(cashierShift.actualCash===null||cashierShift.actualCash===undefined)?expected:cashierShift.actualCash;
  const diff=actual-expected;
  return {paid,unpaid,totalSales,cash,card,qr,expected,actual,diff};
}
...
function closeShiftAuto(){
  ...
  cashierShift.lastClosing={opening:cashierShift.opening,cash:d.cash,card:d.card,qr:d.qr,expenses:cashierShift.expense,expected:d.expected,actual:d.actual,difference:d.diff,orders:d.paid.length};
